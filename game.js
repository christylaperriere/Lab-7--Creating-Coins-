...
var actorChars = {
  ...
  "v": Jewel //A jewel is what is needed to finish a level.
  //There will be only one on each level and they will be hard to get to.
};
...
var jwobbleSpeed = 4, jwobbleDist = 0.1;
...
Jewel.prototype.act = function(step) {
  this.wobble += step * jwobbleSpeed;
  var wobblePos = Math.sin(this.wobble) * jwobbleDist;
  this.pos = this.basePos.plus(new Vector(1, wobblePos));
};
